...
public class Enemie {
	...
	public void drawEnemie(Graphics g) {
		...
		switch (this.IDO) {
		case 1:
			direction(g, Main.sheet.a1, Main.sheet.a2, Main.sheet.a3, Main.sheet.a4, Main.sheet.a5, Main.sheet.a6,
					Main.sheet.a7, Main.sheet.a8);
			break;

		case 2:
			direction(g, Main.sheet.b1, Main.sheet.b2, Main.sheet.b3, Main.sheet.b4, Main.sheet.b5, Main.sheet.b6,
					Main.sheet.b7, Main.sheet.b8);
			break;

		case 3:
			direction(g, Main.sheet.c1, Main.sheet.c2, Main.sheet.c3, Main.sheet.c4, Main.sheet.c5, Main.sheet.c6,
					Main.sheet.c7, Main.sheet.c8);
			break;

		case 4:
			direction(g, Main.sheet.d1, Main.sheet.d2, Main.sheet.d3, Main.sheet.d4, Main.sheet.d5, Main.sheet.d6,
					Main.sheet.d7, Main.sheet.d8);
			// bis hierhin sind Krabbelviecher
			break;

		case 5:
			sh(g, Main.sheet.e, Main.sheet.e);
			break;

		case 6:
			sh(g, Main.sheet.f, Main.sheet.f);
			break;

		case 7:
			sh(g, Main.sheet.g1, Main.sheet.g1);
			break;

		case 8:
			sh(g, Main.sheet.h, Main.sheet.h);
			break;

		case 9:
			sh(g, Main.sheet.i, Main.sheet.i);
			// bis hierhin sind die hässlichen Flug Dinger
			break;

		case 10:
			sh(g, Main.sheet.j1, Main.sheet.j2);
			break;

		case 11:
			sh(g, Main.sheet.k1, Main.sheet.k2);
			break;

		case 12:
			sh(g, Main.sheet.l1, Main.sheet.l2);
			break;

		case 13:
			sh(g, Main.sheet.m1, Main.sheet.m2);
			break;

		case 14:
			sh(g, Main.sheet.n1, Main.sheet.n2);
			// weitere flug Dinger
			break;

		case 15:
			direction(g, Main.sheet.o1, Main.sheet.o2, Main.sheet.o3, Main.sheet.o4, Main.sheet.o5, Main.sheet.o6,
					Main.sheet.o7, Main.sheet.o8);
			break;

		case 16:
			direction(g, Main.sheet.p1, Main.sheet.p2, Main.sheet.p3, Main.sheet.p4, Main.sheet.p5, Main.sheet.p6,
					Main.sheet.p7, Main.sheet.p8);
			break;

		case 17:
			direction(g, Main.sheet.q1, Main.sheet.q2, Main.sheet.q3, Main.sheet.q4, Main.sheet.q5, Main.sheet.q6,
					Main.sheet.q7, Main.sheet.q8);
			// die schnecken kommen
			break;

		case 18:
			sh(g, Main.sheet.r1, Main.sheet.r2);
			break;

		case 19:
			sh(g, Main.sheet.s1, Main.sheet.s2);
			break;

		case 20:
			sh(g, Main.sheet.t1, Main.sheet.t2);
			// weitere Flugdinger
			break;

		case 21:
			direction(g, Main.sheet.u1, Main.sheet.u2, Main.sheet.u3, Main.sheet.u4, Main.sheet.u5, Main.sheet.u6,
					Main.sheet.u7, Main.sheet.u8);
			break;

		case 22:
			direction(g, Main.sheet.v1, Main.sheet.v2, Main.sheet.v3, Main.sheet.v4, Main.sheet.v5, Main.sheet.v6,
					Main.sheet.v7, Main.sheet.v8);
			// zwei Bodenkrabbler
			break;

		case 23:
			sh(g, Main.sheet.w1, Main.sheet.w2);
			break;

		case 24:
			sh(g, Main.sheet.z, Main.sheet.z);
			break;

		case 25:
			sh(g, Main.sheet.zz, Main.sheet.zz);
			// drei Seepferde
			break;
		}
	}
