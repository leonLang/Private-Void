...
public class Enemie {
	...
	public void drawEnemie(Graphics g) {
		...
		case 2:
			direction(g, Game.sheet.b1, Game.sheet.b2, Game.sheet.b3, Game.sheet.b4, Game.sheet.b5,Game.sheet.b6, Game.sheet.b7, Game.sheet.b8);
			break;

		case 3:
			direction(g, Game.sheet.c1, Game.sheet.c2, Game.sheet.c3, Game.sheet.c4, Game.sheet.c5, Game.sheet.c6, Game.sheet.c7, Game.sheet.c8);
			break;

		case 4:
			direction(g, Game.sheet.d1, Game.sheet.d2, Game.sheet.d3, Game.sheet.d4, Game.sheet.d5, Game.sheet.d6, Game.sheet.d7, Game.sheet.d8);
		...
		case 15:
			direction(g, Game.sheet.o1, Game.sheet.o2, Game.sheet.o3, Game.sheet.o4, Game.sheet.o5, Game.sheet.o6, Game.sheet.o7, Game.sheet.o8);
			break;

		case 16:
			direction(g, Game.sheet.p1, Game.sheet.p2, Game.sheet.p3, Game.sheet.p4, Game.sheet.p5, Game.sheet.p6, Game.sheet.p7, Game.sheet.p8);
			break;

		case 17:
			direction(g, Game.sheet.q1, Game.sheet.q2, Game.sheet.q3, Game.sheet.q4, Game.sheet.q5, Game.sheet.q6, Game.sheet.q7, Game.sheet.q8);
		...
		case 21:
			direction(g, Game.sheet.u1, Game.sheet.u2, Game.sheet.u3, Game.sheet.u4, Game.sheet.u5, Game.sheet.u6,Game.sheet.u7, Game.sheet.u8);
			break;

		case 22:
			direction(g, Game.sheet.v1, Game.sheet.v2, Game.sheet.v3, Game.sheet.v4, Game.sheet.v5, Game.sheet.v6, Game.sheet.v7, Game.sheet.v8);
			// zwei Bodenkrabbler
			break;
